...
* 
*/
#ifndef _YSX_MEETING_BreakoutRooms_INTERFACE_H_
#define _YSX_MEETING_BreakoutRooms_INTERFACE_H_
...
public:
	...
	virtual SDKError SetEvent(YSXSDK::IMeetingBreakoutRoomsEvent* pEvent) = 0;
	...
	///If the function fails, the return value is NULL.
	virtual std::vector<YSXSDK::IBreakoutRoomsInfo* >* GetBreakoutRoomsInfoList() = 0;
};
